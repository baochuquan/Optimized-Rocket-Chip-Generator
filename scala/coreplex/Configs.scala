...
class BaseCoreplexConfig extends Config (
  topDefinitions = { (pname,site,here) => 
    ...
    pname match {
      ...
      case TLBLevel => findBy(CacheName)
      case L1TLBEntries => findBy(CacheName)
      case L1TLBReplaceAlgorithm => findBy(CacheName)
      case L2TLBWays => findBy(CacheName)
      case L2TLBSets => findBy(CacheName)
      case L2TLBReplaceAlgorithm => findBy(CacheName)
      ...
      case "L1I" => {
        ...
        case TLBLevel => 1 
        case L1TLBEntries => 8
        case L1TLBReplaceAlgorithm => "PLRU"
        case L2TLBWays => 4
        case L2TLBSets => 8
        case L2TLBReplaceAlgorithm => "PLRU"
        case CacheIdBits => 0
      ...
      case "L1D" => {
        ...
        case TLBLevel => 2
        case L1TLBEntries => 8
        case L1TLBReplaceAlgorithm => "RLRU"
        case L2TLBWays => 4
        case L2TLBSets => 8
        case L2TLBReplaceAlgorithm => "RANDOM"
        case CacheIdBits => 0
        case SplitMetadata => false
      }:PF
      case ECCCode => None
